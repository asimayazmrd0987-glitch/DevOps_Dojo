...
> An interactive, browser-based DevOps learning sandbox with hands-on Linux, Docker, Kubernetes labs — powered by an AI mentor.

[![Live Demo](https://img.shields.io/badge/Live%20Demo-vercel-black?style=for-the-badge&logo=vercel)](https://dev-ops-dojo.vercel.app)
...
**[➡️ dev-ops-dojo.vercel.app](https://dev-ops-dojo.vercel.app)**
...
- Trigger events and job configuration
...
- [x] Linux command line sandbox
- [x] Docker containerization labs
- [x] Kubernetes deployment labs
- [x] CI/CD pipeline labs
- [x] AI-powered mentor integration
...
<p align="center">
  <a href="https://dev-ops-dojo.vercel.app">Live Site</a> •
  <a href="https://github.com/asimayazmrd0987-glitch/DevOps_Dojo">GitHub</a>
</p>
